...
<<<<<<< HEAD
                                    ...
                                    <td>
                                        <?php if (!empty($p['price']) && (float)$p['price'] > 0): ?>
                                            <strong>₹<?= number_format((float)($p['sale_price'] ?: $p['price']), 2) ?></strong>
                                            <?php if (!empty($p['sale_price']) && (float)$p['sale_price'] < (float)$p['price']): ?>
                                                <small class="text-muted d-block"><del>₹<?= number_format((float)$p['price'], 2) ?></del></small>
                                            <?php endif; ?>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <?php if (($p['stock_status'] ?? 'in_stock') === 'out_of_stock'): ?>
