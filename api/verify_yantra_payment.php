...
try {
    ...
    if ($payment['status'] === 'captured') {
        ...
        if ($stmt->rowCount() > 0) {
            echo json_encode([
                'status' => 'success',
                'message' => 'भुगतान सफल! आपका ऑर्डर कन्फर्म हो गया है। 🙏',
            ]);
        } else {
            echo json_encode([
                'status' => 'info',
                'message' => 'भुगतान सत्यापित हो गया है लेकिन ऑर्डर पहले से अपडेट था।',
            ]);
        }
    } else {
        $sql = "UPDATE yantraproducts 
        ...
        echo json_encode([
            'status' => 'error',
            'message' => 'भुगतान कैप्चर नहीं हुआ। कृपया सपोर्ट से संपर्क करें।',
        ]);
    }
} catch (Exception $e) {
    error_log('Yantra Payment Verification Error: ' . $e->getMessage());
    echo json_encode(['status' => 'error', 'message' => 'भुगतान सत्यापन विफल। कृपया सपोर्ट से संपर्क करें।']);
}