-- SQL setup for PHPAuth tables and default admin user
...
-- Password: admin123
INSERT INTO `phpauth_users` (`email`, `password`, `isactive`) VALUES
('admin@vastumitra.com', '$2y$10$Fa6w6zzt3JTOIVSWcxbH0e8Iw23DINN/xmqBFiprCdJNwSrGBFPya', 1);

-- Drop our old 'admin' table if it exists
